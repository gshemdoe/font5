...
//     if(res.status == 200) {
//         let cf = confirm('✔ Video sent successfully to your inbox, return to Telegram to watch it.')
...
//     }
//     else if (res.status == 404) {
//         let cf = confirm(`Ooops! I couldn't send this video to you, the possible reason is that, you blocked Booster Bot on Telegram. Close this message and click "OPEN IN TELEGRAM" button to continue`)
//     }
// }
