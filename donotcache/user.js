...
let tableToHide = document.getElementById('tableToHide')
let defaultTableDisplay = tableToHide.style.display
...
scrollToBtn.addEventListener('click', () => {
    ...
    if(ourUserBox.style.display == 'none' || tableToHide.style.display == 'none') {
        ourUserBox.style.display = 'block'
        tableToHide.style.display = defaultTableDisplay
    }
