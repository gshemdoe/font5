...
real.addEventListener('click', async () => {
    try {
        ...
        errorWindow.document.write(err.message + "<br></h3><h3>Error! Failed to add points, Telegram the screenshot of this error to @blackberryTZ</h3>")
